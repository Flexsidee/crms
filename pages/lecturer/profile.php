...
$sql = "SELECT * FROM lecturers_view WHERE user_id = ?";
...
if ($result->num_rows == 1) {
  ...
  $lecturerName = $lecturer['title_alias'] . " " . $lecturer['surname'] . " " . $lecturer['firstname'] . " " . $lecturer['othername'];
  $lecturerEmail = $lecturer['email'];
  $lecturerStaffId = $lecturer['staff_id'];
  $lecturerTel = $lecturer['tel'];
  $lecturerGender = $lecturer['gender_name'];
} else {
              ...
              <div class="card-body">
                <div class="profile-personal-info">
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-9"><span><?php echo $lecturerName; ?></span>
                    </div>
                  </div>
                  <div class="row mb-4">
                    <div class="col-3">
                    ...
                    <div class="col-9"><span><?php echo $lecturerStaffId; ?></span>
                    </div>
                  </div>
                  <div class="row mb-4">
                    <div class="col-3">
                    ...
                    <div class="col-9"><span><?php echo $lecturerEmail; ?></span>
                    </div>
                  </div>
                  <div class="row mb-4">
                    <div class="col-3">
                    ...
                    <div class="col-9"><span><?php echo $lecturerTel; ?></span>
                    </div>
                  </div>
                  <div class="row mb-4">
                    <div class="col-3">
                    ...
                    <div class="col-9"><span><?php echo $lecturerGender; ?></span>
                    </div>
                  </div>
                </div>
              </div>
