      ...
      <div class="container-fluid">
        <div class="row page-titles mx-0">
          <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
              <h4>Add Admins</h4>
              <p class="mb-0">Fill the form below to add an admin</p>
            </div>
          </div>
          <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./index.php">Home</a></li>
              <li class="breadcrumb-item active"><a href="./add-admin.php">Add Admin</a></li>
            </ol>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xl-12 col-xxl-12">
            <div class="card">
              <div class="card-body">
                <form action="../../actions/superadmin/process_add_admin.php" method="post">
                  <div class="basic-form">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12 justify-content-sm-end d-flex ">
                        <button type="submit" class="btn btn-primary ml-3">Add Admin</button>
                      </div>
                    </div>
                  </div>
                </form>
